    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                out.println("<ul>");
                while(rs.next()) {
                    out.println("<li>" + rs.getString(1)+"  "+rs.getInt(2));
                }
                st.executeUpdate("INSERT INTO employee VALUES('tarun', 6)");
                con.close();
            ...
            out.println("<form method=\"GET\" action=\"NewServlet\">");
            out.println("<input type=\"text\" name=\"StudName\" >");
